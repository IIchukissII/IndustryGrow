...
| `gateway/provision_identity.py`, `gateway/profile_client.py`, `gateway/files/systemd/industrygrow-profile-pull.*`, `gateway/files/app/gateway_timesync.py`, `gateway/files/systemd/industrygrow-timesync.service` | Gateway identity provisioning (ADR-0007 d9), the profile-pull client (ADR-0015 d5-7, ADR-0025) and the bus time master (ADR-0002 d11) | GNU Affero General Public License v3.0 or later | [`AGPL-3.0-or-later`](LICENSES/AGPL-3.0-or-later.txt) |
