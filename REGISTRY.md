...
| `E0002-000001-D-case-src.zip` | `E0002-000001` M01-CLIMATE board | Enclosure design source (Inventor `.ipt`, bottom half). Slug-revisioned (`-case`). Licensing inherits the `store/**` default. |
