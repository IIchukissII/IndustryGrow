...
| `SP0008` | Axial fan, 60 × 60 × 25 mm, 24 V DC over 18–26 V, ≥ 56 m³/h free air at ≤ 3 W, ball bearing, L10 ≥ 60 000 h at 40 °C, externally commandable duty | no | The `E2` element of `E0012`, mounted on `SP0007`. Sized on the **ebm-papst 614 NHH**, the 24 V member of the 612/614 pair; the 612 is the 12 V member and does not meet this line. Parameters are in `spec/E0012-R-specification.md` §4; any part meeting the spec substitutes (ADR-0019 d3). A speed signal and a go/no-go alarm exist only as custom variants and are not taken, so this fan gates no interlock. An actuator device under d6, and the unit's one wear part, so it carries its own line rather than disappearing into the heatsink's. |
