...
| `E0005` | M04-PLANT sensor module | electrical | Module-ID strap `0b100`. Plant-level: MLX90640 thermal imager, 32x24, 110° × 75° FOV population. `E0005-000001` carries this complement in both schematic and layout. Not yet fabricated. Specification: `spec/M04-PLANT-specification.md`. |
