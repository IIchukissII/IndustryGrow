...
class Settings(BaseSettings):
    ...
    # because it copies img/ to a fixed place. A missing file prints the report
    # without the mark rather than failing it.
    report_logo: str = Field(default="../img/industrygrow-mark.svg")
