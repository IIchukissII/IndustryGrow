...
| Released `store/E0001-000001-F-*` | All four personalities; **unsigned** — flashes over SWD, refused over the bus. Rebuild with `tools/release.sh --key` before any over-the-air use |
