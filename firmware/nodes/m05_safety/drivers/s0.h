 ...
 * Energy [J] = pulses * 3 600 000 / (meter pulse constant imp/kWh) — published
 * in joule, base SI (ADR-0005 rev 1 d3). The constant is a per-deployment value
 * (ADR-0018) — a register default for now (ADR-0005 d7). */
void s0_init(void);
