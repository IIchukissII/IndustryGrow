...
| 4 | Sensor platform | 3 | ADR-0014 (rev 5), ADR-0018 | Full cabinet telemetry (M01–M05) — **end of Phase 1** |
...
- ADR-0014 (rev 5) — sensor node taxonomy (M01–M07; only M01–M05 are scheduled here).
