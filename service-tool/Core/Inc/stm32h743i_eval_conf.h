...
/* JOY define. The five-way is on the MB1246 motherboard, so it is fitted on
   both eval boards and works with any LCD daughterboard or none. */
...
#define USE_EXC7200_TS_CTRL                 1U /* confirmed: answered at 0x08 */
