...
- `O-109` — Condensate accumulation rate is a process variable and is barred from this module by ADR-0031 d8. Proposed to M05 as a pulse input on the ADR-0018 d5 S0 pattern. Blocks the `O-111` measurement.
