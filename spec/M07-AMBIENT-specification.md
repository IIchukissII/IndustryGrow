...
Shared `O-` namespace. O-3, O-5, O-7, O-9, O-32 to O-41 are M01's; O-2, O-4, O-6, O-8, O-10,
O-11, O-42 are M06's; O-25 to O-31 are M05's. The **Variant** column records which deployment
variant an item gates.
