...
| **V5** | F3, F4, S12, S22, S23, S26, S28 | Execute one `-M-` protocol end to end; file the emitted record through I6 and read it back; confirm the blob is unchanged | **Passed 2026-09-01** against instance `E0010-000099-000001`: `E0002-000001-M-bringup-protocol` run to 23 of 23 passed, the emitted record filed as `QP` through I6 and read back byte-identical (md5 `49fe265e`, 2 884 B) |
